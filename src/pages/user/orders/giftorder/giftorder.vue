<template>
    <v-content class="operate-giftorder-wrap">
        
        <v-modal :width="1300" title="礼品订单详情" :visible="detailVisible" @ok="handleOk" @cancel="handleCancel"> 
...
<style src="./giftorder.less" lang="less"></style>
