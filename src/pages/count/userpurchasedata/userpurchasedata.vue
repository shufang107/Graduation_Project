       ...
       <div :style="`height:${gridHeight};width:${gridWidth};text-align:left`">
           <v-data-table :data='getData' :columns='columns' :currentData='cartlistData'>
               <template slot="td" slot-scope="props">
                    ...
                    <div v-else-if="props.column.field == 'transactionPerUser'">
                        {{props.item.unit}}{{props.content.toFixed(2)}}
                    </div>
                    <div v-else-if="props.column.field == 'orderCountPerUser'">
                        {{props.content.toFixed(2)}}
                    </div>
                    <div v-else-if="props.column.field == 'productCountPerUser'">
                        {{props.content.toFixed(2)}}
                    </div>
...
export default {
    ...
    created() {
        ...
        this.columns = [
            { title: "日期", field: "date"},
            { title: "活跃用户数", field: "userCount"},
            { title: "订单数", field: "orderCount" },
            { title: "销售额", field: "totalTransaction"},
            { title: "销量", field: "productCount"},
            { title: "人均订单", field: "orderCountPerUser" },
            { title: "人均消费", field: "transactionPerUser" },
            { title: "人均购买件数", field: "productCountPerUser" },
        ];
    },
    mounted() {},
    methods: {
...
<style src="./userpurchasedata.less" lang="less"></style>
