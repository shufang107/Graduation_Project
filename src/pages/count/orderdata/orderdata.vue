       ...
       <div :style="`height:${gridHeight};width:${gridWidth};text-align:left`">
           <v-data-table :data='getData' :columns='columns' :currentData='cartlistData'>
               <template slot="td" slot-scope="props">
                    ...
                    <div v-else-if="props.column.field == 'transactionPerItem'">
                        {{props.item.unit}}{{props.content.toFixed(2)}}
                    </div>
...
export default {
    ...
    created() {
        ...
        this.columns = [
            ...
            { title: "平均客单价", field: "transactionPerUser"},
            { title: "平均件单价", field: "transactionPerItem" },
...
<style src="./orderdata.less" lang="less"></style>
